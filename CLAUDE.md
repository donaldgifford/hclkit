...
`hclkit` is a Go binary maintained as part of the homelab fleet:
...
- Lives on Forgejo (`github.com/donaldgifford/hclkit`); a
...
- `just build` — `go build -o bin/hclkit ./cmd/hclkit`
